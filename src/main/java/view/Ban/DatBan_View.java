...
public class DatBan_View extends JPanel {
    ...
    private JPanel createTableCard(TableInfo table) {
        ...
        Color bgColor = table.status.getColor();
        ...
        JLabel capacityLabel = new JLabel(table.capacity + " chỗ");
        capacityLabel.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        capacityLabel.setForeground(new Color(255, 255, 255, 200));
        capacityLabel.setHorizontalAlignment(SwingConstants.CENTER);
        
        card.add(nameLabel, BorderLayout.CENTER);
        card.add(capacityLabel, BorderLayout.SOUTH);
        ...
        card.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                JOptionPane.showMessageDialog(card, 
                    "Quản lý bàn: " + table.name + "\nTrạng thái: " + table.status.getText(),
                    "Chi tiết bàn",
