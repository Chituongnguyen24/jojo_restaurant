...
public class KhachHang_TraCuu_View extends JPanel {
    ...
    public KhachHang_TraCuu_View() {
        ...
        JLabel subtitle = new JLabel("Tìm kiếm và lọc khách hàng theo hạng hoặc thông tin cá nhân");
        ...
        txtSearch.addActionListener(e -> loadKhachHangData());

        cboFilter = new JComboBox<>(new String[]{"Tất cả", "Thành viên", "Khách thường"});
        ...
        JLabel lblTableTitle = new JLabel("Danh sách khách hàng tra cứu được");
    ...
    private void loadKhachHangData() {
        ...
        List<KhachHang> filtered = dsKH.stream().filter(kh -> {
            ...
            boolean matchFilter = filter.equals("Tất cả")
                    || (filter.equals("Thành viên") && kh.isLaThanhVien())
                    || (filter.equals("Khách thường") && !kh.isLaThanhVien());
