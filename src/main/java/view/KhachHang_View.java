...
public class KhachHang_View extends JPanel {
        ...
        public KhachHang_View() {
            ...
            JButton btnAdd = new JButton("+ Thêm khách hàng thân thiết");
            ...
            statsPanel.add(createStatBox("3", "Tổng", new Color(255, 153, 51)));
            statsPanel.add(createStatBox("1", "Đồng", new Color(100, 200, 100)));
            statsPanel.add(createStatBox("1", "Vàng", new Color(100, 200, 100)));
            statsPanel.add(createStatBox("1", "Bạc", new Color(100, 200, 100)));
            ...
            // ===== TABLE =====
            String[] cols = {"Mã KH", "Thông tin", "Liên hệ", "Email", "Điểm tích lũy", "Hạng", "Trạng thái", "Thao tác"};
            Object[][] data = {
                    {"NV001", "Nguyễn Thị Mai\nNữ - 15/5/1995", "0901234567\nnguyenthi@jojo.com", "123456789012", "Quản lý", "15,000,000đ", "Hoạt động", "✎  🗑"},
                    {"NV002", "Trần Văn Hùng\nNam - 20/8/1992", "0912345678\ntranvan@jojo.com", "123456789013", "Tiếp tân", "8,000,000đ","Hoạt động", "✎  🗑"},
                    {"NV003", "Lê Thị Lan\nNữ - 3/12/1998", "0923456789\nlelan@jojo.com", "123456789014", "Tiếp tân", "7,000,000đ", "Hoạt động", "✎  🗑"}
            };
            ...
            JLabel lblTableSub = new JLabel("Quản lý thông tin khách hàng");
