...
(N'PDB00011', '2025-09-05 18:30', '2025-09-05 18:30', '2025-09-05 20:00', N'KH25000005', N'NVTT001', N'B001', 4, N'Bàn gần cửa sổ', N'Đã đến'),
(N'PDB00012', '2025-09-10 19:00', '2025-09-10 19:00', '2025-09-10 21:00', N'KH25000006', N'NVTT003', N'B205', 8, N'Tiệc công ty', N'Đã đến'),
(N'PDB00013', '2025-09-15 12:00', '2025-09-15 12:00', '2025-09-15 13:30', N'KH25000001', N'NVTT005', N'ST03', 2, NULL, N'Đã đến'),
(N'PDB00014', '2025-09-20 19:30', NULL, NULL, N'KH25000007', N'NVTT007', N'VIP02', 12, N'Khách không đến', N'Không đến'),
(N'PDB00015', '2025-09-25 18:00', '2025-09-25 18:00', '2025-09-25 19:45', N'KH25000004', N'NVTT009', N'SV08', 6, N'Bàn ngoài trời', N'Đã đến'),
-- PHIẾU ĐÃ KẾT THÚC (Tháng 10 - Dữ liệu cũ)
(N'PDB000001', '2025-10-25 18:00', '2025-10-25 18:05', '2025-10-25 19:30', N'KH25000004', N'NVTT001', N'B005', 4, N'4 người lớn, bàn yên tĩnh', N'Đã đến'),
(N'PDB000002', '2025-10-25 19:30', '2025-10-25 19:40', '2025-10-25 21:00', N'KH25000006', N'NVTT002', N'VIP01', 10, N'Tiệc sinh nhật', N'Đã đến'),
(N'PDB000003', '2025-10-28 12:00', '2025-10-28 12:00', '2025-10-28 13:15', N'KH25000001', N'NVTT003', N'B201', 2, N'Cần bàn có sạc điện thoại', N'Đã đến'),
...
-- 10. CHITIETPHIEUDATBAN (Mở rộng cho các PDB mới)
INSERT INTO [dbo].[CHITIETPHIEUDATBAN] ([maMonAn], [maPhieu], [soLuongMonAn], [DonGiaBan], [ghiChu]) VALUES
-- PDB00011 (Tổng 300k)
(N'MA0005', N'PDB00011', 1, 120000.00, NULL),
(N'MA0006', N'PDB00011', 1, 180000.00, NULL),
-- PDB00012 (Tổng 1240k)
(N'MA0002', N'PDB00012', 2, 320000.00, N'Nhiều riêu'),
(N'MA0007', N'PDB00012', 4, 150000.00, N'Gà nướng sate'),
-- PDB000002 (Tổng 1120k)
(N'MA0001', N'PDB000002', 2, 350000.00, N'Lẩu Thái ít cay'),
(N'MA0005', N'PDB000002', 4, 120000.00, N'Ba chỉ heo nướng'),
-- PDB000006 (Tổng 1230k)
(N'MA0003', N'PDB000006', 1, 330000.00, N'Lẩu kim chi cay nồng'),
(N'MA0006', N'PDB000006', 5, 180000.00, N'Sườn bò Mỹ nướng'),
-- PDB000009 (Tổng 420k)
(N'MA0008', N'PDB000009', 2, 160000.00, N'Tôm nướng, nướng kỹ'),
(N'MA0014', N'PDB000009', 4, 25000.00, N'4 lon Coca')
GO
...
(N'HD2509050001', N'NVTT001', N'KH25000005', N'B001', '2025-09-05', '2025-09-05 18:30', '2025-09-05 20:00', N'Tiền mặt', N'KM25TV01', N'VAT08', N'PDB00011', 300000.00, 15000.00, 0), 
...
(N'HD2509250001', N'NVTT009', N'KH25000004', N'SV08', '2025-09-25', '2025-09-25 18:00', '2025-09-25 19:45', N'Tiền mặt', N'KM25TV02', N'VAT08', N'PDB00015', 690000.00, 69000.00, 0),
...
(N'HD2510300002', N'NVTT005', N'KH00000000', N'ST02', '2025-10-30', '2025-10-30 20:00', '2025-10-30 20:45', N'Tiền mặt', N'KM00000000', N'VAT08', NULL, 605000.00, 0.00, 0),
